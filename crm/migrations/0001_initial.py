    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_approved', models.BooleanField(choices=[(True, '审核通过'), (False, '未审核')], default=False, help_text='在审阅完学员的资料无误后勾选此项,合同即生效', verbose_name='审批通过')),
                ...
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.Campuses', verbose_name='校区')),
            ],
        ),
        migrations.CreateModel(
            name='PaymentRecord',
